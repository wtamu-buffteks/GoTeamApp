...
//            tabLayout.getTabAt(i).setIcon(R.drawable.search_icon);
//        }


        final int selectedTabIconColor = Color.parseColor("#FFFFFF");
        final int unselectedTabIconColor = Color.parseColor("#D3D3D3");
...
*/
    ...
    @Override
    public void onListFragmentInteractionCalendarDate(ParseObject item) {
